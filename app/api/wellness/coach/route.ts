...
import { initWellnessTables, calculateWellnessScore } from "@/lib/wellness/db-wellness";
...
export async function GET(request: NextRequest) {
  try {
    ...
    const score = calculateWellnessScore(agentId);
    return respond.success(score);
  } catch { return respond.serverError("Failed to get wellness score"); }
}
